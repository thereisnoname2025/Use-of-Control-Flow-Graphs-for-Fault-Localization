...
public class LikelihoodForOneMutant {
	...
	public LikelihoodForOneMutant(int passed, int failed, String bugLineNumber, double max, int doubleNum) {
		LikelihoodForOneMutant.passed = passed;
		LikelihoodForOneMutant.failed = failed;
		LikelihoodForOneMutant.bugLineNumber = bugLineNumber;
		LikelihoodForOneMutant.max = max;
		LikelihoodForOneMutant.doubleNum = doubleNum;
	}
